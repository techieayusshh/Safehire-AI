...
SafeHire AI is a modern web application that uses deep learning to detect scam jobs and fake internships. It leverages NLP and a trained LSTM neural network to analyze job descriptions and predict the likelihood of fraud, helping students and job seekers stay safe.
